...
This assignment contract template is provided by ${process.env.LEGAL_ENTITY_NAME || 'DealFlow AI'}
for informational purposes only and is NOT legal advice. This template:
