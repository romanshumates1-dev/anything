...
export interface PlanFromDB {
  ...
  limits: {
    ...
    overage_sms_cents: number | null;
    overage_email_cents: number | null;
    overage_ai_credit_cents: number | null;
    campaigns: number;
    seats: number;
 ...
 */
export function transformPlanForUI(plan: PlanFromDB): PlanForUI {
