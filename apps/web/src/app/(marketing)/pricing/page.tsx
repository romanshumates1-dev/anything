...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: ['100 SMS/month', '1,000 emails/month', '500 AI credits', 'Basic analytics', 'Email support'],
    limits: { sms: 100, email: 1000, ai: 500 },
    overage: { sms: 0.10, email: 0.001, ai: 0.06 },
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    features: ['500 SMS/month', '5,000 emails/month', '2,500 AI credits', 'AI negotiation', 'Priority support', 'Buyer matching'],
    limits: { sms: 500, email: 5000, ai: 2500 },
    overage: { sms: 0.08, email: 0.001, ai: 0.04 },
  },
  {
    id: 'business',
    name: 'Business',
    ...
    features: ['1,500 SMS/month', '15,000 emails/month', '10,000 AI credits', 'Team features', 'API access', 'Dedicated success manager'],
    limits: { sms: 1500, email: 15000, ai: 10000 },
    overage: { sms: 0.06, email: 0.001, ai: 0.03 },
  },
  {
    id: 'scale',
    name: 'Scale',
    ...
    features: ['5,000 SMS/month', '50,000 emails/month', '35,000 AI credits', 'White-label options', 'Custom integrations', 'SLA guarantee'],
    limits: { sms: 5000, email: 50000, ai: 35000 },
    overage: { sms: 0.05, email: 0.001, ai: 0.02 },
  },
];

const SMS_PACKS = [
  { name: 'Starter', sms: 1000, price: 99, perSms: 0.099, margin: 85 },
  { name: 'Growth', sms: 5000, price: 449, perSms: 0.0898, margin: 83 },
  { name: 'Pro', sms: 15000, price: 999, perSms: 0.0666, margin: 77 },
  { name: 'Volume', sms: 50000, price: 2499, perSms: 0.05, margin: 70 },
];

const AI_PACKS = [
  { name: 'Starter', credits: 500, price: 29, perCredit: 0.058, margin: 97 },
  { name: 'Growth', credits: 2500, price: 99, perCredit: 0.0396, margin: 95 },
  { name: 'Pro', credits: 10000, price: 299, perCredit: 0.0299, margin: 93 },
  { name: 'Volume', credits: 50000, price: 1199, perCredit: 0.024, margin: 92 },
];

const CREDIT_PACKS = AI_PACKS.map(p => ({
  credits: p.credits,
  price: p.price,
  perCredit: p.perCredit,
  savings: p.margin > 93 ? Math.round((1 - p.perCredit / 0.058) * 100) : null,
}));
...
const COMPETITOR_COMPARISON = [
  ...
  { feature: 'AI Negotiation', dealflow: true, propstream: false, resimpli: false, batchleads: false },
  ...
  { feature: 'Starting Price', dealflow: 'Free / $99', propstream: '$99/mo', resimpli: '$149/mo', batchleads: '$119/mo' },
